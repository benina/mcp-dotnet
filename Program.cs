...
public static class DnlibTools
{
    ...
    public static string _AssemblyPath = "";
    ...
    public static string SaveAssembly(
        [Description("File name no path to save the assembly")]
        string  fileName,
        [Description("Whether to save in mixed mode")]
        bool mixedMode = false
        )
    {
        string path = Path.Combine(Path.GetDirectoryName(_AssemblyPath), fileName);
        if (Module == null)
            return "No assembly loaded.";
